...
const ProductDetails = ({products, products2}) => {
  const router = useRouter()
  const { slug } = router.query
  const { onAdd , qty , toggleCartItemQuanitity, incQty,decQty } = useStateContext();
  console.log(onAdd)
  return <><div>
    <section class="text-gray-600 body-font overflow-hidden">
      <div class="container px-5 mt-28 mx-auto">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={urlFor(products.image && products.image[0])} />
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 class="text-sm title-font text-gray-500 tracking-widest">{products.name}</h2>
            ...
            <div class="flex">
              ...
              <button onClick={()=>onAdd(products,qty)} class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Add to Cart</button>
...
<section class="text-gray-600 body-font">
      ...
      <h1 className='text-4xl font-extrabold ml-14 mt-5'>Explore More Products</h1>
